-- ============================================================
-- Migration 00022: Fix Audit RPCs
-- ============================================================
-- Idempotent migration that ensures all audit system objects
-- exist. Safe to run even if 00021 was already applied.
-- ============================================================

-- 1. Ensure activity_logs has enhanced columns
DO $$ BEGIN
